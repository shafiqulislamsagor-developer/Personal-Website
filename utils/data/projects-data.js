export const projectsData = [
  {
    ...
    name: "SM Food",
    description:
      "SM Food features a distinctive design and ensures responsiveness across all devices. It includes email/password authentication with error messages, and social media login options. The interactive navbar displays user-specific options. Users can manage products and profiles, with functionalities to add, update, and delete products, ensuring a seamless experience.",
    tools: [
      "HTML",
      "CSS",
      "Tailwind CSS",
  ...
  },
  {
    ...
    name: "SM Textile",
    description:
      "SM Textile features a distinct design and ensures responsiveness across all devices. It includes email/password authentication with social media login options and error messages. The interactive navbar displays user-specific options. Users can efficiently update, delete products, and manage profiles within the application.",
    tools: [
      "HTML",
      "CSS",
      "Tailwind CSS",
